    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[70vh] mx-auto py-8 bg-black">
      ...
      <div className="col-span-2 px-5 text-white my-auto">
        <h1 className="text-white text-4xl sm:text-5xl lg:text-8xl font-extrabold">
          ...
          <TypeAnimation sequence={["Frontend Dev", 1000, "Consultant", 1000]} wrapper="span" speed={50} repeat={Infinity} />
        </h1>
        ...
        <div className="my-8">
          <a href="../assets/CV dan Portofolio.pdf" className="px-6 py-3 w-full rounded-xl mr-4 bg-gradient-to-br from-orange-500 to-pink-500 text-white">
            Download CV
          </a>
